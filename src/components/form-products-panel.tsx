        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-2 text-sm text-[var(--muted)]">
              أضف المنتج هنا مباشرة. الكتالوج العام يبقى المصدر، وهذا النموذج هو المصدر الوحيد للمنتجات الظاهرة للطلاب: الظهور والترتيب ونوع الحجز. الأزياء تستخدم هذه المنتجات ولا تدير كتالوجاً منفصلاً.
            </p>
          </div>
          {canManage ? (
            <Button
